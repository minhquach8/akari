...
from akari.registry.specs import BaseSpec, SpecKindLiteral
...
class IdentityRegistry:
    ...
    def _resolve_by_id_or_name(
        ...
        *,
        ...
        candidates = [
            ...
            if item.name == id_or_name and (item.enabled or include_disabled)
        ]
        if not candidates:
            return None
        if len(candidates) > 1:
    ...
    def get(
        ...
        *,
        ...
        return self._resolve_by_id_or_name(id_or_name, include_disabled=include_disabled)
